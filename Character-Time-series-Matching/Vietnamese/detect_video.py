...
def parse_opt():
    ...
    parser.add_argument('--video', type=str, default='demo.mp4', help='video path')
...
if __name__ == '__main__':
    ...
    fps = 24  # Desired FPS for processing
    frame_interval = int(cap.get(cv2.CAP_PROP_FPS) // fps)  # Calculate interval to match 4 FPS
